# Case 4 of ysdragon/tree-sitter-ring issue #2 -- digit-leading identifiers
...
#
# Nested call, digit-leading identifier. THE DEFECT. Narrowed from
# stzlib/base/test/string/112_repeatedntimes.ring line 13:45.
# Before the fix: REJECTED
